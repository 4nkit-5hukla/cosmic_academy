...
class AdminAddCoursePopUp extends StatefulWidget {
  static String routeName = "/a/add-course";
  final String title;

  const AdminAddCoursePopUp({super.key, required this.title});

  @override
  State<AdminAddCoursePopUp> createState() => _AdminAddCoursePopUpState();
}

class _AdminAddCoursePopUpState extends State<AdminAddCoursePopUp> {
  final globalController = Get.find<GlobalController>();
  final authController = Get.find<AuthController>();
  final courseController = Get.put(AdminCourseController());
