...
class AdminTestRunScreen extends StatefulWidget {
  static String routeName = "/a/test/run/:guid";
  static String routePath = "/a/test/run";

  const AdminTestRunScreen({super.key});

  @override
  State<AdminTestRunScreen> createState() => _AdminTestRunScreenState();
}

class _AdminTestRunScreenState extends State<AdminTestRunScreen> {
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Row(
            children: [
              if (testController.testSessionId.value.isEmpty)
                const Icon(
                  Icons.visibility,
                ),
              if (testController.testSessionId.value.isEmpty) spaceH5,
              Text(
        ...
        body: Obx(() {
          if (testQuestionsController.isLoading.value == true) {
            ...
            if (testQuestionsController.testQuestions.isNotEmpty) {
              ...
              if (questionType == 'la' && questionChoices!.isEmpty) {
                questionChoices.add(
                  Choice(choice: "", correctAnswer: "0"),
                );
              }
                      ...
                      children: [
                        ...
                        Column(
                          children: [
                            ...
                            if (testController.testSessionId.value.isNotEmpty)
                              Directionality(
...
class TestRunDrawer extends StatelessWidget {
  ...
  final AdminTestController testController;
