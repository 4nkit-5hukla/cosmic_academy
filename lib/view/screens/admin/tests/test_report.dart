...
class AdminTestReportScreen extends StatefulWidget {
  static String routeName = "/a/test/report/:guid";
  static String routePath = "/a/test/report";
  final String title;

  const AdminTestReportScreen({super.key, required this.title});

  @override
  State<AdminTestReportScreen> createState() => _AdminTestReportScreenState();
}

class _AdminTestReportScreenState extends State<AdminTestReportScreen> {
  final testSubmissionsController = Get.find<AdminTestSubmissionsController>();
  final testController = Get.find<AdminTestController>();
  final testReportController = Get.find<AdminTestReportController>();
