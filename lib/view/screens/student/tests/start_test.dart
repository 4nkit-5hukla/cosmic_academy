...
class StudentStartTestScreen extends StatefulWidget {
  static String routeName = "/test/start/:guid";
  static String routePath = "/test/start";
  final String title;

  const StudentStartTestScreen({
    super.key,
    required this.title,
  });

  @override
  State<StudentStartTestScreen> createState() => _StudentStartTestScreenState();
}

class _StudentStartTestScreenState extends State<StudentStartTestScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    String currentTestType = testController.currentTest.type;
    String routePath = currentTestType == 'quiz'
        ? StudentQuizRunScreen.routePath
        : StudentTestRunScreen.routePath;
    return Scaffold(
