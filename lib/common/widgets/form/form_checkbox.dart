...
class FormCheckbox extends FormBuilderField<String> {
          ...
          builder: (FormFieldState<String> field) {
            ...
            return InputDecorator(
              ...
              child: CheckboxListTile(
                ...
                title: title,
                subtitle: subtitle,
                value: tristate ? state.value == 'true' : state.value == 'true',
  ...
  @override
  FormBuilderFieldState<FormCheckbox, String> createState() =>
      _FormBuilderCheckboxState();
}

class _FormBuilderCheckboxState
    extends FormBuilderFieldState<FormCheckbox, String> {}
